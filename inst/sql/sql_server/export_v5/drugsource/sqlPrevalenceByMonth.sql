...
from 
	(select CAST(stratum_1 as int) stratum_1, CAST(stratum_2 as int) stratum_2, count_value from @results_database_schema.ACHILLES_results where analysis_id = 9702 GROUP BY analysis_id, stratum_1, stratum_2, count_value) num
	inner join
